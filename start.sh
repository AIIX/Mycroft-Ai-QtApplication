...
case $1 in
	...
	"gui") SCRIPT=${TOP}/mycroft/client/gui/gui.py ;;	
	...
	*) echo "Usage: start.sh [service | skills | skill_container | voice | cli | guignome | guikde | audiotest | collector | unittest | enclosure | pairing | sdkdoc ]"; exit ;;
esac
