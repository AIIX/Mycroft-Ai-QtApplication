...
class AudioConsumer(threading.Thread):
    ...
    def process_audio(self, audio):
	    ...
	    remote_object = bus.get_object("com.mycroftkde.KDEPlasmoid","/ComMycroftkdeKDEPlasmoidInterface")  
            setText = remote_object.setText("Sorry, I didn't catch that.", dbus_interface = "com.mycroftkde.KDEPlasmoid")		
    ...
    def _create_remote_stt_runnable(self, audio, utterances):
		...
		bus = dbus.SessionBus()
		remote_object = bus.get_object("com.mycroftkde.KDEPlasmoid","/ComMycroftkdeKDEPlasmoidInterface")  
		getvoiceQuery = remote_object.setText("Your device is not registered yet. To start pairing, login at cerberus.mycroft.ai", dbus_interface = "com.mycroftkde.KDEPlasmoid")
		...
		bus = dbus.SessionBus()
		remote_object = bus.get_object("com.mycroftkde.KDEPlasmoid","/ComMycroftkdeKDEPlasmoidInterface")  
		getvoiceQuery = remote_object.setText(text, dbus_interface = "com.mycroftkde.KDEPlasmoid")
